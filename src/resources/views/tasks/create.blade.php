...
<form method="POST" action="/createController">
    ...
    <div class="form-group">
        <label>Start</label>
        <input id="start" name="start" type="datetime-local" step="1" class="form-control @error('start') is-invalid @enderror">
        @error('start')
    ...
    <div class="form-group">
        <label>Time</label>
        <input id="duration" name="duration" type="time" step="1" class="form-control @error('duration') is-invalid @enderror">
        @error('duration')
